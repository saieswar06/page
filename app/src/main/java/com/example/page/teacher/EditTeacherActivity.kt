...
class EditTeacherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnSaveTeacher.setOnClickListener { updateTeacher() }
    ...
    private fun updateTeacher() {
        ...
        val passwordToSend = if (password.isEmpty() || password == "******") {
            null
        } else {
        ...
        val updateRequest = UpdateTeacherRequest(
            ...
            email = email,
            phone = phone,
            defaultPassword = passwordToSend,
        ...
        RetrofitClient.getInstance(this)
            .updateTeacher(teacher?.uid ?: 0, updateRequest)
